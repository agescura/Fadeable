...
Pod::Spec.new do |s|
  s.name             = 'AgilFadeable'
  s.version          = '0.1.0'
  s.summary          = 'A short description of AgilFadeable.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/AgilFadeable'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Albert Gil Escura' => 'agilescura@gmail.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/AgilFadeable.git', :tag => s.version.to_s }
